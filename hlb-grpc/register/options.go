...
type Endpoints struct {
	...
	//Fuse           bool   `json:"fuse"`            //TODO熔断
	//Defaults       []byte `json:"defaults"`        //TODO熔断默认值
}
...
func newOptions(opt ...RegisterOptions) *Options {
	opts := &Options{
		...
		Node:        &Node{Version: "latest", Online: true},
		RegisterTtl: 10,
...
func SetOnline(online bool) RegisterOptions {
	return func(options *Options) {
		options.Node.Online = online
	}
}
